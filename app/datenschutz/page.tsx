 ...
 *
 * TODO Kerim: vor dem Livegang von jemandem mit Rechtskenntnis gegenlesen
 * lassen. Anschrift und Aufsichtsbehoerde stehen seit 13.08.2026 drin.
 */
    ...
    <div className="mx-auto w-full max-w-2xl px-5 py-20 sm:px-8 sm:py-28">
      ...
      <div className="mt-10 flex flex-col gap-8 text-[15px] leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Die Schriften dieser Seite, Fraunces und Space Grotesk, liegen auf
            meinem eigenen Server und werden von dort ausgeliefert. Beim Aufruf
            der Seite geht deshalb keine Verbindung zu Google, und es wird keine
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Alle Bilder, auch die Screenshots aus den Instagram Insights, liegen
            auf meinem eigenen Server. Sie zeigen Zahlen aus Konten, die ich
